   ...
   return (
      <PageModel id="home" trasnsitionImg={true}>
         <div className="flex flex-row-reverse flex-wrap flex-[1_1] gap-2 items-center justify-around min-h-screen max-[605px]: pt-18 pb-9">
            ...
            <div className="flex flex-col gap-6 w-87 max-[350px]:px-2">
               <div>
                  <h2 className="max-[350px]:text-3xl text-center text-[2.35rem] py-2 font-bold bg-linear-to-r from-(--third-color) to-(--second-color) bg-clip-text text-transparent">Emerson Rodrigues</h2>
                  <h1
                     className="text-(--text-gray-color) font-light tracking-widest -mt-4 text-center"
