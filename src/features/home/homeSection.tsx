...
export function HomeSection() {
   return (
      <section className="flex flex-row-reverse flex-wrap flex-[1_1]  gap-2 items-center justify-center min-h-[calc(100vh-48px)] overflow-hidden min-w-full bg-(--main-color) text-white">

         <MainImage />

         <div className="flex flex-col gap-3 w-87">
            <div>
